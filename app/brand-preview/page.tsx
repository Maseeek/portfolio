...
import { ArrowLeft, Sparkles, Layers, Cpu, Code2, Box, Check, Copy, Flame, Compass } from "lucide-react";
...
export default function BrandPreviewPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-20 px-[clamp(1.25rem,4vw,3.5rem)] relative overflow-hidden">
      {/* Background ambient lighting */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-accent/10 rounded-full blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="max-w-[1400px] mx-auto space-y-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-white/10 pb-8">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs uppercase px-3 py-1 bg-accent/10 border border-accent/30 text-accent font-bold rounded-full">
                Active Brand System
              </span>
            </div>
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs font-mono text-white/50">Selected Concept:</span>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-mono text-accent/90">{concept.subtitle}</p>
                ...
                <div className="pt-6 mt-6 border-t border-white/5 space-y-3">
                  ...
                  <button
                    ...
                    className="w-full py-2 rounded-xl text-xs font-mono border border-white/10 hover:bg-white/10 transition-colors flex items-center justify-center gap-2"
                  >
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 md:p-12 space-y-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-6">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white mt-1">
                Selected: {concepts.find((c) => c.id === selectedConcept)?.title}
              </h2>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="w-full p-4 rounded-2xl glass border border-white/10 flex justify-between items-center bg-black/50">
              <div className="flex items-center gap-3">
              ...
              <div className="px-4 py-2 rounded-full bg-white text-black text-xs font-bold uppercase tracking-wider">
                Let's Talk →
              </div>
            </div>
          </div>
